...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText edtNameRegister = findViewById(R.id.edittext_name_register);
        EditText edtEmailRegister = findViewById(R.id.edittext_email_register);
        EditText edtPasswordRegister = findViewById(R.id.edittext_password_register);
